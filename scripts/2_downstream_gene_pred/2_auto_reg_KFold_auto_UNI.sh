#!/bin/bash
# Phase 2 sweep for the UNI student: 5-fold gene expression regression over the
...
#   DATASETS="breast" bash 2_auto_reg_KFold_auto_UNI.sh
#   BINNED_OPTIONS="false true" FEATURE_TYPES="peka" bash 2_auto_reg_KFold_auto_UNI.sh
